...
Use this page as the navigator for all business documentation files under the `business` folder.
...
| Folder | Description |
|---|---|
| [Flows](flows/00_business_flows_index.md) | Separate workflow documents for each major business flow in the solution. |

## Business Flow Documents

| # | Flow | File |
|---|---|---|
| 0 | Flow Index | [00_business_flows_index.md](flows/00_business_flows_index.md) |
| 1 | Catalog and Package Setup | [01_catalog_and_package_setup_flow.md](flows/01_catalog_and_package_setup_flow.md) |
| 2 | Counselling and Program Selection | [02_counselling_and_program_selection_flow.md](flows/02_counselling_and_program_selection_flow.md) |
| 3 | File Opening | [03_file_opening_flow.md](flows/03_file_opening_flow.md) |
| 4 | Payment and Deposit Confirmation | [04_payment_and_deposit_confirmation_flow.md](flows/04_payment_and_deposit_confirmation_flow.md) |
| 5 | Admission Processing | [05_admission_processing_flow.md](flows/05_admission_processing_flow.md) |
| 6 | Visa Processing | [06_visa_processing_flow.md](flows/06_visa_processing_flow.md) |
| 7 | University Commission Tracking | [07_university_commission_tracking_flow.md](flows/07_university_commission_tracking_flow.md) |
| 8 | Reporting and Dashboard | [08_reporting_and_dashboard_flow.md](flows/08_reporting_and_dashboard_flow.md) |
