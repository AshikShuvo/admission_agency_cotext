# REP-EP1-US1-BE1: Implement owner dashboard summary API with file, payment, due, activity, and commission aggregates.
...
| User Story | [REP-EP1-US1: Owner Dashboard](../stories/REP-EP1-US1_owner_dashboard.md) |
| Task Type | `BE` |
...
Module: REP
Story: REP-EP1-US1
Completed task: REP-EP1-US1-BE1
Files changed:
Tests run:
Tracker updated:
Open blockers:
