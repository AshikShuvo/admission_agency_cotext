...
- Users can filter authorized records by date, status, consultant, stage, and university.
- Reports calculate totals, counts, dues, and work queues.
- Reports never leak unauthorized data.
