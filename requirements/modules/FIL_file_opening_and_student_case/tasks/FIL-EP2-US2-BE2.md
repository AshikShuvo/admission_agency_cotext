# FIL-EP2-US2-BE2: Add query-layer scope filters for Owner, Consultant, Accounts, Admission, and Visa.
...
| User Story | [FIL-EP2-US2: View Student File Detail](../stories/FIL-EP2-US2_view_student_file_detail.md) |
| Task Type | `BE` |
...
Module: FIL
Story: FIL-EP2-US2
Completed task: FIL-EP2-US2-BE2
Files changed:
Tests run:
Tracker updated:
Open blockers:
