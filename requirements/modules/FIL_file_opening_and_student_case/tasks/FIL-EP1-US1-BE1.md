# FIL-EP1-US1-BE1: Create student entity and DTOs for profile, guardian, academic, and passport metadata.
...
| User Story | [FIL-EP1-US1: Register Student Profile](../stories/FIL-EP1-US1_register_student_profile.md) |
| Task Type | `BE` |
...
Module: FIL
Story: FIL-EP1-US1
Completed task: FIL-EP1-US1-BE1
Files changed:
Tests run:
Tracker updated:
Open blockers:
