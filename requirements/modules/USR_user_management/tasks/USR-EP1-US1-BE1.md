# USR-EP1-US1-BE1: Create user entity fields for profile, role, department, status, and login email.
...
| User Story | [USR-EP1-US1: Create Staff User](../stories/USR-EP1-US1_create_staff_user.md) |
| Task Type | `BE` |
...
Module: USR
Story: USR-EP1-US1
Completed task: USR-EP1-US1-BE1
Files changed:
Tests run:
Tracker updated:
Open blockers:
