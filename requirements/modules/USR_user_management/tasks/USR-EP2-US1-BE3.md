# USR-EP2-US1-BE3: Add tests for suspension, login blocking, and historical activity preservation.
...
| User Story | [USR-EP2-US1: Suspend Staff Access](../stories/USR-EP2-US1_suspend_staff_access.md) |
| Task Type | `BE` |

## Business Context

As an Owner, I want to suspend staff access so that former or inactive employees cannot use the system.
...
- [ ] Suspended user cannot log in or access protected APIs.
- [ ] Previous work history remains visible for audit.
...
Module: USR
Story: USR-EP2-US1
Completed task: USR-EP2-US1-BE3
Files changed:
Tests run:
Tracker updated:
Open blockers:
