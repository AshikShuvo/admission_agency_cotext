# VIS-EP1-US1-FE1: Build visa checklist view with required and optional visa document items.
...
| User Story | [VIS-EP1-US1: Generate Visa Checklist](../stories/VIS-EP1-US1_generate_visa_checklist.md) |
| Task Type | `FE` |
...
Module: VIS
Story: VIS-EP1-US1
Completed task: VIS-EP1-US1-FE1
Files changed:
Tests run:
Tracker updated:
Open blockers:
