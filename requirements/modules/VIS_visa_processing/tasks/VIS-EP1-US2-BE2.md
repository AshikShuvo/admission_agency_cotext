# VIS-EP1-US2-BE2: Enforce document completeness and visa payment clearance before submission.
...
| User Story | [VIS-EP1-US2: Submit Visa Application](../stories/VIS-EP1-US2_submit_visa_application.md) |
| Task Type | `BE` |
...
Module: VIS
Story: VIS-EP1-US2
Completed task: VIS-EP1-US2-BE2
Files changed:
Tests run:
Tracker updated:
Open blockers:
