...
- Authorized users can place files on hold with reason.
- Owner or authorized users can cancel files with reason.
- On-hold files can resume.
- Cancelled files preserve history and block normal edits.
