# EXC-EP2-US1-BE2: Create new visa attempt records while preserving previous rejection history.
...
| User Story | [EXC-EP2-US1: Review Visa Rejection and Reapplication](../stories/EXC-EP2-US1_review_visa_rejection_and_reapplication.md) |
| Task Type | `BE` |
...
Module: EXC
Story: EXC-EP2-US1
Completed task: EXC-EP2-US1-BE2
Files changed:
Tests run:
Tracker updated:
Open blockers:
