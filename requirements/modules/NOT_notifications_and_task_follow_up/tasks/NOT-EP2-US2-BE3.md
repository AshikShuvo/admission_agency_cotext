# NOT-EP2-US2-BE3: Add tests for unauthorized resolve attempts and timestamp persistence.
...
| User Story | [NOT-EP2-US2: Mark Notification Read or Resolved](../stories/NOT-EP2-US2_mark_notification_read_or_resolved.md) |
| Task Type | `BE` |
...
Module: NOT
Story: NOT-EP2-US2
Completed task: NOT-EP2-US2-BE3
Files changed:
Tests run:
Tracker updated:
Open blockers:
