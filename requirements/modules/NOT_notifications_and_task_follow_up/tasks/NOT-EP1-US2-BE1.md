# NOT-EP1-US2-BE1: Wire notification events from file creation, payment confirmation, admission approval, and visa outcome services.
...
Module: NOT
Story: NOT-EP1-US2
Completed task: NOT-EP1-US2-BE1
Files changed:
Tests run:
Tracker updated:
Open blockers:
