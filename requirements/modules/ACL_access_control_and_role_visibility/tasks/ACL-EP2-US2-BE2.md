# ACL-EP2-US2-BE2: Apply sensitive field filtering to file detail, reports, payments, documents, and commissions.
...
| User Story | [ACL-EP2-US2: Filter Sensitive Fields](../stories/ACL-EP2-US2_filter_sensitive_fields.md) |
| Task Type | `BE` |
...
Module: ACL
Story: ACL-EP2-US2
Completed task: ACL-EP2-US2-BE2
Files changed:
Tests run:
Tracker updated:
Open blockers:
