# CAT-EP1-US1-BE3: Add tests for owner CRUD, non-owner blocking, inactive filtering, and duplicate handling.
...
9. Include fixtures for allowed and blocked roles, valid and invalid inputs, and important workflow states.
...
Module: CAT
Story: CAT-EP1-US1
Completed task: CAT-EP1-US1-BE3
Files changed:
Tests run:
Tracker updated:
Open blockers:
