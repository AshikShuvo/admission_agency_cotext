# CAT-EP1-US2-BE3: Add tests for university ownership, active filtering, and program selection eligibility.
...
| User Story | [CAT-EP1-US2: Manage Programs](../stories/CAT-EP1-US2_manage_programs.md) |
| Task Type | `BE` |
...
Module: CAT
Story: CAT-EP1-US2
Completed task: CAT-EP1-US2-BE3
Files changed:
Tests run:
Tracker updated:
Open blockers:
