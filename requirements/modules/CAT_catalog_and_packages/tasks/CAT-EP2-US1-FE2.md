# CAT-EP2-US1-FE2: Show automatic stage totals, total package cost, and validation for missing or negative amounts.
...
| User Story | [CAT-EP2-US1: Configure Stage-wise Packages](../stories/CAT-EP2-US1_configure_stage_wise_packages.md) |
| Task Type | `FE` |
...
Module: CAT
Story: CAT-EP2-US1
Completed task: CAT-EP2-US1-FE2
Files changed:
Tests run:
Tracker updated:
Open blockers:
