# ADM-EP1-US2-BE1: Implement document metadata, upload reference, and checklist item attachment APIs.
...
| User Story | [ADM-EP1-US2: Submit and Verify Admission Documents](../stories/ADM-EP1-US2_submit_and_verify_admission_documents.md) |
| Task Type | `BE` |
...
Module: ADM
Story: ADM-EP1-US2
Completed task: ADM-EP1-US2-BE1
Files changed:
Tests run:
Tracker updated:
Open blockers:
