# ADM-EP1-US1-BE3: Add tests for checklist persistence, role access, and notification event creation.
...
| User Story | [ADM-EP1-US1: Generate Admission Checklist](../stories/ADM-EP1-US1_generate_admission_checklist.md) |
| Task Type | `BE` |
...
Module: ADM
Story: ADM-EP1-US1
Completed task: ADM-EP1-US1-BE3
Files changed:
Tests run:
Tracker updated:
Open blockers:
